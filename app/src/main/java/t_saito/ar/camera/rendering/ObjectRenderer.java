 ...
 */
package t_saito.ar.camera.rendering;
...
public class ObjectRenderer {
     ...
     */
    public void updateModelMatrix(float[] modelMatrix, float scaleFactor, float angleX, float angleY, float angleZ) {
        ...
        }
        {
            ...
            // ピン止め
            Matrix.setRotateM(rotateMatrix, 0, angleX, -1.0f, 0.0f, 0.0f);
            Matrix.multiplyMM(tmpMatrix, 0, tmpMatrix, 0, rotateMatrix, 0);
            Matrix.setRotateM(rotateMatrix, 0, angleY, 0.0f, -1.0f, 0.0f);
            Matrix.multiplyMM(tmpMatrix, 0, tmpMatrix, 0, rotateMatrix, 0);
            Matrix.setRotateM(rotateMatrix, 0, angleZ, 0.0f, 0.0f, -1.0f);
            Matrix.multiplyMM(this.modelMatrix, 0, tmpMatrix, 0, rotateMatrix, 0);

            double ragZ = Math.atan2(this.modelMatrix[1], this.modelMatrix[0]);
            float angleZZ = (float)(ragZ * 180 / Math.PI);

            Timber.d("updateModelMatrix getRotateZ():%f ragZ:%f x:%f this.modelMatrix[1]:%f angleZ:%f", angleZZ, ragZ, this.modelMatrix[0], this.modelMatrix[1], angleZ);
        }
     ...
     * @see android.opengl.Matrix
     */
    public void draw(MatrixData cameraView, MatrixData cameraPerspective, float lightIntensity) {

        ShaderUtil.checkGLError(TAG, "Before draw");

        // Build the ModelView and ModelViewProjection matrices
        // for calculating object position and light.
        Matrix.multiplyMM(modelViewMatrix, 0, cameraView.getMatrix(), 0, modelMatrix, 0);
        Matrix.multiplyMM(modelViewProjectionMatrix, 0, cameraPerspective.getMatrix(), 0, modelViewMatrix, 0);

//        if (isPinned) {
//            // ピン止め
//            Matrix.setRotateM(rotationMatrix, 0, cameraView.getAngleX(), -1.0f, 0.0f, 0.0f);
//            Matrix.multiplyMM(modelViewProjectionMatrix, 0, modelViewProjectionMatrix, 0, rotationMatrix, 0);
//            Matrix.setRotateM(rotationMatrix, 0, cameraView.getAngleY(), 0.0f, -1.0f, 0.0f);
//            Matrix.multiplyMM(modelViewProjectionMatrix, 0, modelViewProjectionMatrix, 0, rotationMatrix, 0);
//        }
